            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="Editkonten<?= $no; ?>" tabindex="-1" aria-hidden="true"
                            style="display: none;">
                            <div class="modal-dialog modal-lg" role="document">
                                ...
                                <form action="<?= base_url('admin/konten/update') ?>" method="post"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col mb-3">
                                                <label class="form-label">Merk</label>
                                                <input type="text" class="form-control" value="<?= $aa['merk'] ?>"
                                                    name="merk">
                                            </div>
                                            <div class="col mb-3">
                                                <label class="form-label">Kursi</label>
                                                <input type="text" class="form-control" value="<?= $aa['kursi'] ?>"
                                                    name="kursi">
                                            </div>
                                            <div class="col mb-3">
                                                <label class="form-label">Kategori</label>
                        ...
                        <a href="<?= site_url('admin/booking/jadwal/'.$aa['id_konten']); ?>"
                            class="btn btn-sm rounded-pill btn-info">
                            <span>+ Booking</span>
                        </a>

                        <a href="<?= site_url('admin/detail/detail_armada/'.$aa['id_konten']); ?>"
